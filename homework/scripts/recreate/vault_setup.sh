...
#  CLIENT_ID - Frontend client ID (default: flask-backend)
#  CLIENT_SECRET - Frontend client secret (default: generated value)
#  CLIENT_ID_ADMIN - Backend admin client ID (default: admin-cli)
...
CLIENT_ID=${CLIENT_ID:-flask-backend}
CLIENT_SECRET=${CLIENT_SECRET:-iNHzaKf+d01VCBmSSq9G4tz/3PzOopTZE9FuAlZj4Zk=}
CLIENT_ID_ADMIN=${CLIENT_ID_ADMIN:-admin-cli}
